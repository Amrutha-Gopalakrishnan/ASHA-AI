...
// //           target="_blank"
// //           rel="noreferrer"
// //           className="px-4 py-1 bg-purple-600 text-white rounded-md text-sm font-medium hover:bg-purple-700 mb-2"
// //         >
// //           Apply Now
// //         </a>
// //         <span className="text-xs bg-gray-100 px-2 py-1 rounded">{job.employment_type}</span>
...
//       {/* Applied Jobs */}
//       <section className="bg-white p-4 sm:p-6 rounded-lg shadow mb-6 sm:mb-8">
//         <h3 className="text-xl font-semibold mb-4 sm:mb-6">Applied Jobs</h3>
//         {appliedJobs.length > 0 ? (
...
//       {/* Saved Jobs */}
//       <section className="bg-white p-4 sm:p-6 rounded-lg shadow mb-6 sm:mb-8">
//         <h3 className="text-xl font-semibold mb-4 sm:mb-6">Saved Jobs</h3>
//         {savedJobs.length > 0 ? (
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
//             {savedJobs.map(renderJobCard)}
//           </div>
...
//       {/* Recently Viewed */}
//       <section className="bg-white p-4 sm:p-6 rounded-lg shadow mb-6 sm:mb-8">
//         <h3 className="text-xl font-semibold mb-4 sm:mb-6">Recently Viewed Jobs</h3>
//         {viewedJobs.length > 0 ? (
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
//             {viewedJobs.map(renderJobCard)}
//           </div>
